...
int a = 1, b = 2;
int c = 3, d = 4;
head.computeIfAbsent(a, l -> new ArrayList<>()).add(b);
head.computeIfAbsent(a, l -> new ArrayList<>()).add(c);
head.computeIfAbsent(a, l -> new ArrayList<>()).add(d);
for (int j : head.getOrDefault(a, Collections.emptyList())) {
